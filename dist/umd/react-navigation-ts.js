/** @license react-navigation-ts v1.0.1
...
(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('react'), require('history'), require('qs'), require('react-router-dom')) :
    typeof define === 'function' && define.amd ? define(['react', 'history', 'qs', 'react-router-dom'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global['react-navigation-ts'] = factory(global.React, global.history, global.qs, global.ReactRouterDOM));
}(this, (function (React, history, qs, reactRouterDom) { 'use strict';
